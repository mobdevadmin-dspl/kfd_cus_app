...
//    @GET("Fdebtor/mobile123/{dbname}/{debcode}/{password}")//02
//    Call<ReadJsonList> getDebtorResult(@Path("dbname") String dbname,@Path("debcode") String debcode,@Path("password") String password);
...
// ------------New  ---------------------------------
    @GET("FDebtor}/{debcode}/{password}")
    Call<ReadJsonList> getDebtorResult(@Path("debcode") String debcode,@Path("password") String password);
    @POST("UpdateCusNewPassword")
    Call<Result> uploadCusNewPassword(@Body JsonObject cuslist, @Header("Content-Type") String cont_type);
    @POST("Order")
    Call<Result> uploadOrder(@Body JsonObject orderlist, @Header("Content-Type") String cont_type);

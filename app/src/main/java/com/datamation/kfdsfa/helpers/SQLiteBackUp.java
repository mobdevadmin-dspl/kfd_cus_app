...
import com.datamation.kfdsfa.model.Import;
...
public class SQLiteBackUp {
    ...
    public void importDB(String name) {
        try {
            ...
            if (sd.canWrite()) {
                ...
                String backupDBPath ="//KFD Order//"+name; // From SD directory.
        ...
        try {
            ...
            if (success) {
                ...
                if (sd.canWrite()) {
                    ...
                    String backupDBPath = "//KFD Order//backupname_"+dateFormat.format(date).toString()+".db"; // From SD directory.
    ...
    @SuppressLint("NewApi") public List<Import> getListOfFiles() {
        ...
        String path = Environment.getExternalStorageDirectory() + "/KFD Order";
    ...
    @SuppressLint("NewApi") public List<Import> getListOfFilesNew() {
